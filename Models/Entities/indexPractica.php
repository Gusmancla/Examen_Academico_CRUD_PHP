...
$sentencia = $db->query("SELECT * FROM Practicas");
...
<body>
    ...
    <center>
        <h3>Lista de registros Practicas</h3>
        <a href="/app_crud_ExamenesAcademicos/Views/forms/usuarios/formPracticaInsert.php"><button>Nuevo registro</button></a>
        <table>
            <tr>
            ...
            <?php foreach ($dato as $registro){?>
                <tr>
                    ...
                    <td><a href="/app_crud_ExamenesAcademicos/Controllers/UPDATE/formPracticasUpdate.php?id=<?php echo $registro->CodigoPractica ?>"><button>Editar</button></a></td>
                    <td><a href="/app_crud_ExamenesAcademicos/Controllers/DELETE/deletePracticas.php?id=<?php echo $registro->CodigoPractica ?>"><button>Eliminar</button></a></td>
                </tr>
